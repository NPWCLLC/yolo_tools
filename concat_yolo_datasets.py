...
def merge_yolo_datasets_to_train(root_dir, output_dir):
    """
...
root_dir = os.path.expanduser("~/TRAIN_DATA/NFS-PUPS-BOXES")  # Укажите путь к корневой папке с датасетами
output_dir = os.path.expanduser("~/TRAIN_DATA/MERGE_NFS-PUPS-BOXES")  # Укажите путь для сохранения данных (все объединится в train)
merge_yolo_datasets_to_train(root_dir, output_dir)
